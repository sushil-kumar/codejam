...
public class Senator2 {
	public static void main(String[] args) {
        ...
        try {
        	...
        	fileToWrite = new FileWriter("files/A-small-practice.out");
                ...
                while (nParty > 0) {
                	if (nParty == 1) {
                		if (nSenator.get(0) == nSenator.get(1)) {
                			...
                			result += senatorName.get(0) + senatorName.get(1) + " ";
                			if (nSenator.get(0) == 2) {
                				System.out.print(senatorName.get(0) + senatorName.get(1) + " ");
                				result += senatorName.get(0) + senatorName.get(1) + " ";
                			}
